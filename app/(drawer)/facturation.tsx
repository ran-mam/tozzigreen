...
export default function FacturationScreen() {
  ...
  const [prixKwh, setPrixKwh] = useState("2 000");
  const [rowValues, setRowValues] = useState(ROWS.map((r) => r.value));
  const [total, setTotal] = useState("24 300");
...
const styles = StyleSheet.create({
  ...
  headerUnit: { color: "rgba(255,255,255,0.85)", fontSize: 16, fontWeight: "700" },
  body: { padding: 18 },
  row: {
    flexDirection: "row",
